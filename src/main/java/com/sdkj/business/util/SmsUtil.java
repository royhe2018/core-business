...
public class SmsUtil {
    ...
    static final String accessKeyId = "LTAIJYW8yaUd9HJJ";
    static final String accessKeySecret = "PtuYdRRkPTNyxCqTs7lnlXhY6ymH5g";
    ...
    public static boolean sendSms(String phoneNumber,String template,Map<String,String> param){
    	try {
            ...
            //必填:短信签名-可在短信控制台中找到
            request.setSignName("易拉科技");
            //必填:短信模板-可在短信控制台中找到
            request.setTemplateCode(template);
            //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
            request.setTemplateParam(JsonUtil.convertObjectToJsonStr(param));
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	...
    	param.put("checkCode", "963852");
        sendSms("15129222933","SMS_152509976",param);
